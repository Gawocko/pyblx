...
`) + "(" + c + ', "' + d + '", ' + a + ")", Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL];
        ...
        if ("SPLIT" === c) c = b.valueToCode(a, "INPUT", Order$$module$build$src$generators$python$python_generator.MEMBER) || "''", a = b.valueToCode(a, "DELIM", Order$$module$build$src$generators$python$python_generator.NONE), a = c + ".split(" + a + ")";
        else if ("JOIN" === c) c = b.valueToCode(a, "INPUT", Order$$module$build$src$generators$python$python_generator.NONE) || "[]", a = (b.valueToCode(a, "DELIM", Order$$module$build$src$generators$python$python_generator.MEMBER) || "''") + ".join(" + c + ")";
...
`);
        ...
        if ($.isNumber$$module$build$src$core$utils$string(d) && $.isNumber$$module$build$src$core$utils$string(e) && $.isNumber$$module$build$src$core$utils$string(f)) d = Number(d), e = Number(e), f = Math.abs(Number(f)), 0 === d % 1 && 0 === e % 1 && 0 === f % 1 ? (d <= e ? (e++, a = 0 === d && 1 === f ? e : d + ", " + e, 1 !== f && (a += ", " + f)) : (e--, a = d + ", " + e + ", -" + f), a = "range(" + a + ")") : (a = d < e ? a() : k(), a += "(" + d + ", " + e + ", " + f + ")");
        else {
...
// node_modules/blockly/python.mjs
var import_python_compressed = __toESM(require_python_compressed(), 1);
var {
  Order,
  PythonGenerator,
  pythonGenerator
} = import_python_compressed.default;
export {
  Order,
  PythonGenerator,
  pythonGenerator
